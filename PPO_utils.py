...
class Data_collecter():
    ...
    def get_buffer(self, m_average_score, net_param):
        ...
        return np.array(self.buffer.buffer[0:self.buffer.buffer_size],dtype=self.buffer.data_type), self.step, self.average_score, self.buffer.buffer_size #buffer_length
